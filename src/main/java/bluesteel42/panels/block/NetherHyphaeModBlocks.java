...
public class NetherHyphaeModBlocks {
    public static final Block RED_NETHER_BRICK_PANEL = ModBlocks.register("red_nether_brick_panel", PanelBlock::new, AbstractBlock.Settings.copy(RED_NETHER_BRICKS));
    ...
    public static void initialize() {
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.BUILDING_BLOCKS)
                .register((itemGroup) -> {
                    itemGroup.addAfter(RED_NETHER_BRICK_SLAB, NetherHyphaeModBlocks.RED_NETHER_BRICK_PANEL);
